...
//#define tenk
#define iot
unsigned long myChannelNumberUp = 673641;
//unsigned long myChannelNumber[4] = {649394, 649395, 649396, 649399};
const char * myWriteAPIKeyUp = "CU6E0TBZ0BKLCYV4"; //amazon_aa_tag_test
